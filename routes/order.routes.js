...
const { createOrder, getOrders, getOrderById, getOrderForTracking, searchOrdersForTracking, updateOrderStatus, cancelOrder, generateOrderInvoice, calculateDeliveryCharge } = require('../controllers/order.controller');
...
router.get('/track/search', optionalAuth, searchOrdersForTracking);
